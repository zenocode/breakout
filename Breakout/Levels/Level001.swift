...
////  Breakout
////
////  Created by Norbert Haubner on 12.03.22.
////
//
//import Foundation
//import SpriteKit
//import GameKit
//
//class Level002: SKScene, ObservableObject, SKPhysicsContactDelegate {
//    
...
//        scoreLabel.position = CGPoint(x: size.width / 1.20, y: size.height / 1.05)
//        addChild(scoreLabel)
//        
//        // Paddle
...
//        makeBricks(row: 7, bitmask: 0b100, y: 800, name: "bluebrick")
//        makeBricks(row: 15, bitmask: 0b100, y: 787, name: "redbrick")
//        makeBricks(row: 7, bitmask: 0b100, y: 774, name: "bluebrick")
...
//    
//    func finishLevel() {
//        let finishScene = Finish002(size: self.size)
//        
